...
3.  **Instale as dependências:**
    Isso vai baixar todas as bibliotecas necessárias (React, Vite, TypeScript, etc.) listadas no `package.json`:
    ```bash
    npm install
    ```
...
5.  **Acesse o jogo:**
    O terminal mostrará um link local (geralmente `http://localhost:3000`). Cole no seu navegador para jogar.
